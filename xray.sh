...
InstallFiles() {
	...
	#install xray
	$download_tool_cmd xray http://wuyi-1251424646.costj.myqcloud.com/xray/${xray_UPX}/linux_${machine} || Error "xray download failed."
	$download_tool_cmd xray.init http://wuyi-1251424646.costj.myqcloud.com/xray/xray.init || Error "xray.init download failed."
	...
	if type systemctl; then
		$download_tool_cmd /lib/systemd/system/xray.service http://wuyi-1251424646.costj.myqcloud.com/xray/xray.service || Error "xray.service download failed."
